...
def segment_text(sentence):
    opts = {
        'meta_file': 'model/ck.r8.s128.l3.meta',
        'checkpoint_file': 'model/ck.r8.s128.l3',
        'sentence': sentence,
        'verbose': None,
        'input_file': None,
    }
    ...
    with tf.Session() as sess:
        ...
        return (process_input_sentence(sess, char_dict, model_settings, model_vars, input_sentence))
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        if input_file is not None:
            ...
            print(process_input_sentence(input_sentence))
